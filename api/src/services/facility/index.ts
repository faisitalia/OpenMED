 ...
 */
   ...
   * @returns 
   */
  async function findNearest(latitude: number, longitude: number, minDistance: number = 0, maxDistance:number = 1000, limit:number = 5) {
  ...
  export { getAllFacilities, getFacilityById, getCoordinatesByAddress, findNearest }