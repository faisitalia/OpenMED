...
<template>
  <div class="mx-4 my-4">
    ...
    <div
      class="flex flex-col items-stretch bg-brandBlue-50/50 rounded-3xl p-5 mt-16"
    >
      <div
        id="audio-test"
      ...
      >
        ...
        <div class="col-start-2 flex flex-row items-center justify-evenly">
          <div class="rounded-3xl bg-brandBlue-50 py-1 w-[calc(100%-5rem)] h-2">
            <div
              class="rounded-3xl relative -top-1 bg-brandBlue-500 w-[calc(100%-5rem)] h-2"
            />
          </div>
        ...
        >
          <option value="Microfono Auricolare" disabled selected>
            Seleziona il tuo microfono
          </option>
        </select>
      </div>
      <div
      ...
      >
        ...
        <button @click.prevent="navigateTo(`/call/start?id=TODO`)">
          Inizio chiamata
        </button>
      </div>
    </div>
